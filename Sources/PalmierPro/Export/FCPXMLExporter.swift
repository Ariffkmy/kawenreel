...
/// effects; edge softness and rounding; Lottie clips; adjustment layers (their effects have no
/// FCPXML mapping — the caller should warn via `unsupportedAdjustmentCount`).
///
    ...
    private final class Builder {
        ...
        private func libraryNode(clips: [EmittableClip]) -> FCPXMLNode {
            FCPXMLNode(name: "library", children: [
                FCPXMLNode(name: "event", attributes: [("name", "Kawenreel Export")], children: [
