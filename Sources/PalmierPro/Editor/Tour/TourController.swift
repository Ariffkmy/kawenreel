    ...
    private static func makeSteps(editor: EditorViewModel) -> [TourStep] {
        [
            ...
            TourStep(kind: .spotlight(.panel(.media)), title: "Media panel",
                     instruction: "All your footage and assets live here. Import with the button, drag and drop, or copy-paste."),
            ...
            TourStep(kind: .spotlight(.panel(.agent)), title: "AI agent",
                     instruction: "Chat with your agent! It can edit clips, organize your assets, and much more. Start by signing in, or bring your own Anthropic API key."),
