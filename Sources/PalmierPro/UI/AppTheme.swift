...
enum AppTheme {
    ...
    enum Window {
        ...
        static let projectTitlebarTrailingWidth: CGFloat = 360
        // home + agent buttons + BETA badge
        static let projectTitlebarLeadingWidth: CGFloat = IconSize.lg * 2 + 60 + Spacing.smMd * 3
    }
